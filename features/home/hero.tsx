          ...
          <div className="text-center lg:text-left">
            ...
            >
              <Button
                size="lg"
                asChild
                className="bg-primary hover:bg-primary-600 text-white shadow-lg shadow-primary/50"
              >
            ...
            <div className="relative w-full h-[500px]">
              ...
              >
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Certifierad kvalitet</h3>
                    <p className="text-slate-400 text-sm">All utrustning är MDR-certifierad</p>
                  </div>
                </div>
              </GlassCard>
              ...
              >
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Komplett utbildning</h3>
                    <p className="text-slate-400 text-sm">Professionell support och träning</p>
                  </div>
                </div>
              </GlassCard>
            </div>
