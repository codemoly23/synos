          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            <motion.div variants={fadeUp} transition={defaultTransition}>
              ...
              <p className="text-lg text-slate-300 mb-8">
                Kontakta oss idag för en kostnadsfri konsultation. Vi hjälper dig att hitta rätt
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-100 font-medium">010-205 15 01</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-100 font-medium">info@synos.se</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <GlassCard padding="lg">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full bg-primary hover:bg-primary-600 text-white shadow-lg shadow-primary/50"
                  >
