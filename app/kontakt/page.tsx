    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
          Har du frågor om våra produkter, utbildningar eller vill veta mer om hur du
          startar din egen klinik? Vi hjälper dig gärna!
        </p>
      </div>
      ...
      <div className="mb-12 grid gap-6 md:grid-cols-3">
        ...
        <div className="rounded-lg border border-border bg-background p-6 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Mån-Fre 09:00-17:00</p>
        </div>
        ...
        <div className="rounded-lg border border-border bg-background p-6 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Följ oss för nyheter</p>
        </div>
      </div>
      ...
      <div className="mt-16 rounded-lg bg-muted/50 p-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            <h3 className="mb-2 font-semibold">Hur snabbt får jag svar?</h3>
            <p className="text-sm text-muted-foreground">
              Vi strävar efter att svara på alla förfrågningar inom 24 timmar under
              vardagar.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Absolut! Ange i meddelandet att du vill boka ett möte så återkommer vi
              med förslag på tider.
            </p>
          </div>
          <div>
            <h3 className="mb-2 font-semibold">Erbjuder ni demonstrationer?</h3>
            <p className="text-sm text-muted-foreground">
              Ja, vi erbjuder kostnadsfria produktdemonstrationer på våra kontor eller
              hos er.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Vi rekommenderar att boka tid innan besök för att säkerställa att rätt
