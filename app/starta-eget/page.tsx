    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="mb-16 text-center">
        <h1 className="mb-6 text-4xl font-bold tracking-tight md:text-5xl">
          ...
          <br />
          <span className="text-primary">Starta klinik med Synos!</span>
        </h1>
        <p className="mx-auto max-w-3xl text-lg text-muted-foreground">
          Är du hudterapeut och funderar på att starta eget? Vill du vara din
          egen chef och kunna styra över dina arbetstider och sysslor på ett
          sätt som du inte kan idag? Funderar du på vad som krävs för att kunna
          förverkliga drömmen om en egen skönhetssalong eller klinik?
        </p>
        <p className="mx-auto mt-4 max-w-3xl text-xl font-semibold text-primary">
      ...
      <section className="mb-20">
        <div className="mb-12 rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 p-8 md:p-12">
          ...
          <p className="mb-4 text-lg leading-relaxed">
            ...
            fettreducering och hårborttagning. Tillsammans med den support och
            kunskap du behöver för att lyckas.
          </p>
          <p className="text-lg leading-relaxed">
            Tänk dig själv som egen företagare, med friheten att skapa din egen
            framgång. Vi hjälper dig hela vägen, från start till mål.
          </p>
        </div>
        ...
        <div className="mb-12 grid gap-8 md:grid-cols-3">
          <Card className="border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                En av våra erfarna experter lär dig allt om din nya maskin,
                steg för steg. Du får både teoretisk och praktisk utbildning så
                att du känner dig trygg och säker när du börjar behandla dina
                kunder.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20">
            <CardContent className="p-8">
              ...
              <h3 className="mb-3 text-xl font-semibold">Helhetslösning</h3>
              <p className="text-muted-foreground">
                Vi hjälper dig med finansiering och försäkring, så att du kan
                fokusera på det viktiga – att bygga upp din klinik.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-primary/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                Om något oväntat skulle hända med din utrustning står vi alltid
                redo att hjälpa dig med service och support.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="mb-20">
        <div className="rounded-lg border border-primary/20 bg-card p-8 md:p-12">
          ...
          <p className="mb-6 text-lg leading-relaxed text-muted-foreground">
            ...
            utrustning. Vi ger dig all den kunskap och det stöd du behöver för
            att lyckas.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  En av våra erfarna experter lär dig allt om din nya maskin,
                  steg för steg. Du får både teoretisk och praktisk utbildning
                  så att du känner dig trygg och säker när du börjar behandla
                  dina kunder.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="mb-2 text-lg font-semibold">Helhetslösning</h3>
                <p className="text-muted-foreground">
                  Vi hjälper dig med finansiering och försäkring, så att du kan
                  fokusera på det viktiga – att bygga upp din klinik.
                </p>
      ...
      <section className="mb-20 rounded-lg bg-gradient-to-r from-primary to-primary-hover p-12 text-center text-white">
        ...
        <p className="mb-8 text-lg opacity-90">
          Vill du veta mer om hur man startar en hudvårdssalong eller klinik ska
          du höra av dig till oss på Synos. Allra smidigast är att boka ett
          förutsättningslöst möte med någon av våra produktspecialister, som då
          snabbt kan få en tydligare bild av dina behov och önskemål.
        </p>
          ...
          <Card className="group overflow-hidden border-primary/20 transition-all hover:border-primary hover:shadow-xl">
            <CardContent className="p-8">
              ...
              <p className="mb-6 text-muted-foreground">
                Ladda ner vår köpguide för att påbörja din resa, boka sedan en
                kostnadsfri miniutbildning för att utöka din kunskap.
              </p>
