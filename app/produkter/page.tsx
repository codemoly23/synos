    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="mb-20">
        <div className="mb-8 text-center">
          <h2 className="mb-3 text-3xl font-bold">Behandlingskategorier</h2>
      ...
      <section className="rounded-lg bg-gradient-to-r from-primary to-primary-hover p-12 text-center text-white">
        <h2 className="mb-4 text-3xl font-bold">Behöver du hjälp att välja?</h2>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        ...
        <Card className="border-primary/20">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Komplett utbildning och support ingår vid köp av utrustning från
              Synos Medical
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-primary/20">
          <CardContent className="p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Vi lagar din maskin inom 48 arbetstimmar och erbjuder automatisk
              service
            </p>
          </CardContent>
        </Card>
