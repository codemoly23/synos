...
export const createProductDraftSchema = z.object({
	...
	heroBackgroundMobileWidth: z.number().optional(),
	heroBackgroundMobileHeight: z.number().optional(),
	heroBackgroundDesktopWidth: z.number().optional(),
	heroBackgroundDesktopHeight: z.number().optional(),
	...
	videoThumbnailWidth: z.number().optional(),
	videoThumbnailHeight: z.number().optional(),
	section1Image: z.string().optional(),
	section1ImageWidth: z.number().optional(),
	section1ImageHeight: z.number().optional(),
	section2TopImage: z.string().optional(),
	section2TopImageWidth: z.number().optional(),
	section2TopImageHeight: z.number().optional(),
	section2BottomImage: z.string().optional(),
	section2BottomImageWidth: z.number().optional(),
	section2BottomImageHeight: z.number().optional(),
	section3Image: z.string().optional(),
	section3ImageWidth: z.number().optional(),
	section3ImageHeight: z.number().optional(),
