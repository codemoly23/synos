		...
		features: [
			{
				...
				description: "Noggrant testade produkter från ledande tillverkare",
			},
			{
				icon: "Award",
				title: "Certifierad utbildning",
				description: "Fullständig utbildning ingår vid varje köp",
			},
			{
				icon: "Shield",
				title: "Trygg service",
				description: "2 års garanti och livstidssupport",
			},
			{
				icon: "Users",
				title: "Personlig kontakt",
				description: "Dedikerade experter som guidar dig genom processen",
			},
		],
	},
