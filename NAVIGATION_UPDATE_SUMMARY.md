...
- **Hover States**: All hover effects now use `hover:text-primary` (medical teal #00949e)
...
- Updated menu header from gradient text to solid `text-primary`
...
- `.text-primary` - Brand teal (#00949e)
...
| Primary Brand | `text-primary` | #00949e |
| Primary Hover | `hover:text-primary-dark` | #007580 |
