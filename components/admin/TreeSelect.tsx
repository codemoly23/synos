...
interface TreeSelectProps {
	...
	multiple?: boolean;
	disabled?: boolean;
	excludeId?: string; // Exclude this ID from selection (useful when editing)
	className?: string;
}
 ...
 * A hierarchical select component for category trees
 */
export function TreeSelect({
	...
	const selectedNames = React.useMemo(() => {
		const names: string[] = [];
		const findNames = (nodes: ICategoryTreeNode[]) => {
