        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/starta-eget" className="hover:text-primary">
                  Starta Eget
                </Link>
              </li>
              <li>
                <Link href="/utbildningar" className="hover:text-primary">
                  Utbildningar
                </Link>
              </li>
              <li>
          ...
          {/* Locations */}
          <div>
            <h3 className="mb-4 text-lg font-semibold">Våra Kontor</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/om-oss/faq" className="hover:text-primary">
                  FAQ
                </Link>
              </li>
            </ul>
