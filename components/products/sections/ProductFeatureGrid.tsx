				...
				<div className={`${cornerClassMap[corners]} bg-[#fafafa] p-6 sm:p-10 lg:p-16 ring-1 ring-slate-200/70`}>
					...
					>
						<div>
							...
							<h2 className="font-heading text-2xl sm:text-3xl lg:text-[2.25rem] font-bold tracking-tight text-secondary leading-[1.15] mb-4">
								{heading}
							</h2>
							{description && (
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
								{features.map((feature, idx) => {
									...
									return (
										<div
											key={idx}
											className="group p-4 sm:p-5 rounded-xl bg-white ring-1 ring-slate-200 hover:ring-primary/50 hover:-translate-y-0.5 hover:shadow-[0_12px_32px_-12px_rgba(220,167,131,0.30)] transition-all duration-300"
										>
											<Icon
												strokeWidth={1.5}
												className="h-6 w-6 text-[#98a7b5] mb-3"
											/>
											<h3 className="text-[15px] font-semibold text-secondary mb-1.5 leading-snug">
												{feature.title}
											</h3>
							...
							<div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
								<div className="lg:col-span-5 flex items-start gap-5 sm:gap-6">
									...
									<div className="flex-1 min-w-0 pt-1">
										<h3 className="text-xl sm:text-2xl lg:text-[1.65rem] font-bold tracking-tight text-secondary leading-[1.2] mb-3">
											{bottomBlock.title}
										</h3>
