...
const steps = [
	{
		...
		title: "Browse & Select",
		description:
			"Explore our extensive catalog of certified medical equipment.",
		icon: Search,
	},
	{
		number: "02",
		title: "Request Quote",
		description:
			"Submit your requirements and get a custom proposal within 24h.",
		icon: FileText,
	},
	{
		number: "03",
		...
		description:
			"We handle logistics, installation, and initial calibration.",
		icon: Truck,
	},
	{
		number: "04",
			...
			<div className="_container">
				<div className="text-center max-w-3xl mx-auto mb-16">
					...
					<p className="text-slate-600 text-lg">
						We make acquiring medical equipment simple, transparent, and
