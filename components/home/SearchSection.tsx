		...
		<section className="py-12 bg-white sm:border-b sm:border-slate-100">
			<div className="container-width">
				<div className="max-w-4xl mx-auto">
					<div className="flex flex-col sm:flex-row gap-4 items-center sm:bg-slate-50 p-2 rounded-full sm:border sm:border-slate-200 sm:shadow-sm sm:focus-within:ring-2 sm:focus-within:ring-accent/20 transition-all">
						...
						/>
						<Button className="w-full sm:w-auto rounded-full px-8 h-12 bg-accent hover:bg-accent-hover text-white font-medium">
							Search
						</Button>
					</div>
					<div className="flex flex-wrap justify-center gap-3 mt-4 text-sm text-slate-600">
						...
						{[
							...
							<button
								key={tag}
								className="text-slate-600 hover:text-accent transition-colors underline decoration-dotted underline-offset-2"
							>
								{tag}
							</button>
						))}
